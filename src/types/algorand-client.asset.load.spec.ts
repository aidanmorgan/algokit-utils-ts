...
describe('Asset Load Testing', () => {
  ...
  // Helper function to get load test timeout from environment variable
  ...
  // Optional: Override timeout with $env:LOAD_TEST_TIMEOUT_MS="64800000" (defaults to 18 hours)
